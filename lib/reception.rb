...
# Checks for availabl rooms, assigns room to new_reservation and adds new reservation to reservations array
    def add_reservation(check_in, check_out)
      ...
      assigned_room = availability_by_date_range(check_in, check_out).first

      new_reservation = Hotel::Reservation.new(check_in, check_out, assigned_room)
...
# # Creates room blocks based on availability_by_date_range
#     def room_block
#
#     end
  end
